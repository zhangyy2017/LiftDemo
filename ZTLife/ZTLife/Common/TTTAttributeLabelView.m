...
- (void)linkStyles {
    ...
    // 没有点击时候的样式
    if (self.linkColor) {
        self.label.linkAttributes       = @{nsStringWithCfString(kCTForegroundColorAttributeName) : linkColor,nsStringWithCfString(kCTUnderlineStyleAttributeName)  : [NSNumber numberWithInt:linkUnderLineStyle]};
    }
